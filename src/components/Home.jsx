  ...
  return (
    <div className="   max-w-screen-xl mx-auto px-3 overflow-hidden pt-12">
      <div className=" header flex justify-between pt-9 items-center">
        ...
        <div className="sm:block hidden inline-block bg-white text-black px-8 py-3 font-outfit rounded-lg  border-2 z-10 border-white hover:text-white hover:bg-transparent h-fit cursor-pointer duration-300 ease-in-out">
          <a
      ...
      >
        ...
        <div className="right md:col-span-6">
          <h1 className=" sm:{max-w-[767px] text-[35px] leading-[55px]} sm:{max-w-[1024px] text-[40px] leading-[60px]} sm:{max-w-[1366px] text-[55px] leading-[75px]}  font-sora font-medium mb-5 ">
